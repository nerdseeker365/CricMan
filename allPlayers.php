              ...
              <div class="col-md-3 col-sm-3">
                  <div class="panel">
                      <div class="panel-body">
                          ...
                          </div><footer class="cd-pricing-footer"><a class="cd-select" href="solomodeAll.php">SOLO Players</a></footer>
              ...
              <div class="col-md-3 col-sm-3">
                  <div class="panel">
                      <div class="panel-body">
						  ...
						  <footer class="cd-pricing-footer"><a class="cd-select" href="vsmodeAll.php">V/S Players</a></h3></button>
                      </div>
                  </div>
              </div>
