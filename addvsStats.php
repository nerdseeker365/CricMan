                                 ...
                                 <div id="battab" class="tab-pane active">
                                      ...
                                      TYPE<select class="" id="ptype" value="odi" name="mtype" tabindex="-1" aria-hidden="true" id="mtype">
										  ...
										  <option value="fc">F.C</option>
											...
											25 : <input type="number" id="fif" name="fif" value="0" onfocus="this.select()" placeholder=""><br/>
											50 : <input type="number" id="hun" name="hun" value="0" onfocus="this.select()" placeholder=""><br/>
