...
// ========================== FC DATA GETTING START ==============================
 $sql = "select * from solo_fc s where s.play_id=".$pid;
 //echo $sql;
...
// ========================== TEST DATA GETTING START ==============================
 $sql = "select * from solo_test s where s.play_id=".$pid;
 //echo $sql;
 $result = mysqli_query ( $conn, $sql ); 
 if (mysqli_num_rows ( $result ) > 0) {
 $row = mysqli_fetch_assoc($result);
...
// ========================== ODI DATA GETTING START ==============================
 $sql = "select * from solo_odi s where s.play_id=".$pid;
 //echo $sql;
 $result = mysqli_query ( $conn, $sql ); 
 if (mysqli_num_rows ( $result ) > 0) {
 $row = mysqli_fetch_assoc($result);
...
// ========================== T20 DATA GETTING START ==============================
 $sql = "select * from solo_tt s where s.play_id=".$pid;
 //echo $sql;
 $result = mysqli_query ( $conn, $sql ); 
 if (mysqli_num_rows ( $result ) > 0) {
 $row = mysqli_fetch_assoc($result);
